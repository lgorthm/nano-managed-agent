 ...
 * GLM_API_KEY / NANO_API_KEY(secret)与 ACCESS_DEV_BYPASS(仅 .dev.vars)不经过 wrangler.jsonc,
...
declare global {
  namespace Cloudflare {
    interface Env {
      GLM_API_KEY: string;
      /** nano API 上游基地址,如 http://127.0.0.1:8787;本地在 .dev.vars,生产配 wrangler.jsonc vars */
      NANO_API_BASE: string;
      /** nano API 鉴权 Key;本地 .dev.vars,生产 wrangler secret put NANO_API_KEY */
      NANO_API_KEY: string;
