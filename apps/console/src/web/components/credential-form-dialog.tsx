...
function CredentialFormFields({
  ...
  return (
    <div className="grid gap-4">
        ...
        <>
          ...
          <div className="grid gap-2">
            ...
            <Select
              ...
              onValueChange={(v) =>
                onChange({
                  networkingType: v as CredentialFormState['networkingType'],
                })
              }
            >
              <SelectTrigger className="w-full">
      ...
      {usesAccessToken ? (
        <div className="grid gap-2">
          <Label htmlFor={`${idPrefix}-access-token`}>
            access_token{isCreate ? '' : '(留空 = 保留现有值)'}
          </Label>
          <Input
      ...
      {isEnvVar ? (
        <div className="grid gap-2">
          <Label htmlFor={`${idPrefix}-secret-value`}>
            变量值{isCreate ? '' : '(留空 = 保留现有值)'}
          </Label>
          <Input
