...
export function postEnvironment(
  body: unknown,
...
export function listEnvironments(
  ...
  return exports.default.fetch(`http://example.com/v1/environments${query}`, {
    headers: authed(headers),
  });
}
...
export function updateEnvironment(
  ...
  return exports.default.fetch(
    `http://example.com/v1/environments/${encodeURIComponent(id)}`,
    init,
  );
}

/** POST /v1/environments/{environmentId}/archive,默认带认证 */
export function archiveEnvironmentViaApi(
  id: string,
  headers: Record<string, string> = {},
): Promise<Response> {
  return exports.default.fetch(
    `http://example.com/v1/environments/${encodeURIComponent(id)}/archive`,
    {
      method: 'POST',
      headers: authed(headers),
    },
...
export function deleteEnvironmentViaApi(
  id: string,
  headers: Record<string, string> = {},
): Promise<Response> {
  return exports.default.fetch(`http://example.com/v1/environments/${encodeURIComponent(id)}`, {
