...
export { type AgentJson, createDefaultAgent } from '../agents/helpers';
export {
...
export function listSessions(query = '', headers: Record<string, string> = {}): Promise<Response> {
  return exports.default.fetch(`${base}/v1/sessions${query}`, {
...
export function archiveSessionViaApi(
  id: string,
  headers: Record<string, string> = {},
): Promise<Response> {
  return exports.default.fetch(sessionUrl(id, '/archive'), {
    method: 'POST',
    headers: authed(headers),
  });
}
...
export function deleteSessionViaApi(
  id: string,
  headers: Record<string, string> = {},
): Promise<Response> {
  return exports.default.fetch(sessionUrl(id), {
...
export function listResources(sessionId: string, query = ''): Promise<Response> {
  return exports.default.fetch(sessionUrl(sessionId, `/resources${query}`), {
    headers: authed(),
  });
}
...
export function getResource(sessionId: string, resourceId: string): Promise<Response> {
  return exports.default.fetch(
    sessionUrl(sessionId, `/resources/${encodeURIComponent(resourceId)}`),
    {
      headers: authed(),
    },
  );
...
export function listEvents(
  ...
  return exports.default.fetch(sessionUrl(sessionId, `/events${query}`), {
    headers: authed(headers),
  });
}
...
export function openEventStream(
  ...
  return exports.default.fetch(sessionUrl(sessionId, `/events/stream${query}`), {
    headers: authed(headers),
  });
}
